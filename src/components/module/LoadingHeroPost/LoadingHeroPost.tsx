interface ILoadingHeroPostProps {
    heightImage?: number
}

const LoadingHeroPost = ({ heightImage = 480 }: ILoadingHeroPostProps) => {
    return (
        <div role='status' className='w-full relative bg-light rounded-lg shadow animate-pulse'>
            <div
